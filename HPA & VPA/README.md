# Kubernetes HPA & VPA Controller (Horizontal/Vertical Pod Autoscaler) on KIND/Minikube Cluster
...
1. Create 1 virtual machine on AWS with 2 CPU, 4GB of RAM (t2.medium)
2. Setup minikube on it
3. Ensure you have the Metrics Server installed in your Minikube cluster to enable HPA. If not already installed, you can install it using:
```bash
...
```
----------------------------------------
### Implementation on a Kind cluster 
